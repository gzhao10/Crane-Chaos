...
enum EntityType { PLATFORM, PLAYER, ENEMY, HEART};
...
public:
    ...
    float      const get_left_edge()      const { return m_left_edge;       };
    float      const get_right_edge()     const { return m_right_edge;      };
    ...
    void const set_left_edge(float new_left_edge)           { m_left_edge = new_left_edge;          };
    void const set_right_edge(float new_right_edge)         { m_right_edge = new_right_edge;        };
};
